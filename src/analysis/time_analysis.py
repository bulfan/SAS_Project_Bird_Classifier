...
class TimeAnalysisPipeline:
    ...
    def plot_waveform(self, file_path: str, class_name: Optional[str] = None, file_id: Optional[str] = None) -> None:
    ...
    def run(self, dataset: Optional["BirdSoundDataset"] = None, train_dataset: Optional["BirdSoundDataset"] = None) -> List[Dict[str, Any]]:
            ...
            if self.folder_path:
                ...
                if folder.exists():
                    ...
                    for i, audio_file in enumerate(audio_files):
                        ...
                        self.plot_waveform(str(audio_file), class_name=class_name, file_id=file_id)
